...
// * UhfPlugin
// */
//public class UHFPlugin implements FlutterPlugin, MethodCallHandler, KeyEventCallback {
//
...
//    private static final String Channel_Key_read = "readKeyBoard";
...
//    private static final PublishSubject<Integer> keyCode = PublishSubject.create();
//
...
//        keyReadEvent(flutterPluginBinding.getBinaryMessenger());
//        channel.setMethodCallHandler(new UHFPlugin());
//        UHFHelper.getInstance().init();
//        UHFHelper.getInstance().setUhfListener(new UHFListener() {
//            @Override
...
//                    @Override
//                    public void onError(Throwable e) {
//                        tagsStatus.onNext(Objects.requireNonNull(e.getMessage()));
//                    }
//
//                    @Override
//                    public void onComplete() {
...
//
//
//    private static void keyReadEvent(BinaryMessenger messenger) {
//        final EventChannel scannerEventChannel = new EventChannel(messenger, Channel_Key_read);
//        scannerEventChannel.setStreamHandler(new EventChannel.StreamHandler() {
//            @Override
//            public void onListen(Object o, final EventChannel.EventSink eventSink) {
//                keyCode
...
//
//                    @Override
//                    public void onNext(Integer tag) {
//                        eventSink.success(tag);
//                    }
//
//                    @Override
...
//
//    @Override
//    public void onDetachedFromEngine(@androidx.annotation.NonNull @NonNull FlutterPluginBinding binding) {
//    }
//
//
//
