package com.ar.uhf2new.uhf2new;

import com.ar.uhf2new.uhf2new.helper.UHFHelper;
import com.ar.uhf2new.uhf2new.helper.UHFListener;
...
/** Uhf2newPlugin */
public class Uhf2newPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  private static final String CHANNEL_ListenKeyboard = "listen_input_keys";
  private static final String CHANNEL_TagsStatus = "TagsStatus";
  private static final PublishSubject<Boolean> connectedStatus = PublishSubject.create();
  ...
  public static void registerWith(PluginRegistry.Registrar registrar) {
    ...
    channel.setMethodCallHandler(new Uhf2newPlugin());
  ...
  @Override
  public void onAttachedToEngine(@io.reactivex.annotations.NonNull FlutterPluginBinding flutterPluginBinding) {
  ...
  private static void listenInputKeyBoard(BinaryMessenger messenger) {
    final EventChannel listenkeyBoard = new EventChannel(messenger, CHANNEL_ListenKeyboard);
    listenkeyBoard.setStreamHandler(new EventChannel.StreamHandler() {
      @Override
      public void onListen(Object o, final EventChannel.EventSink eventSink) {
        eventSink.success(o);
      }
  ...
  @Override
  public void onMethodCall(@io.reactivex.annotations.NonNull MethodCall call, @io.reactivex.annotations.NonNull Result result) {
